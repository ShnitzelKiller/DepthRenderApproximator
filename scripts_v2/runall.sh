...
export LD_LIBRARY_PATH=/projects/grail/jamesn8/projects/DepthRenderApproximator/scripts_v2/temppath:/local1/libs:$LD_LIBRARY_PATH
source /local1/mitsuba-master/setpath.sh
render_cmd=/projects/grail/jamesn8/projects/DepthRenderApproximator/depth_grid_render/build_roberts/depth_grid_render
...
outdir=/projects/grail/jamesn8/projects/DepthRenderApproximator/output/full-randomized-augmented-scene
...
for filename in ${datadir}/*_Y.exr; do
    ...
    $render_cmd $datadir/$depth_map $hdrdir/$env_map $theta $phi $alpha $datadir/$mask_map -tex $outtex -ltheta $light_theta -lphi $light_phi -save $outdir/$tag -output_masks 1 #-scenes ${render_base}${render_tex}${render_wotex}${render_flipped}${render_woflipped}${render_spec}${render_wospec}${render_directspec}${render_wodirectspec}${render_directdiffuse}${render_wodirectdiffuse}
